...
| File | What it is |
|---|---|
| [FELSEFE.md](FELSEFE.md) | The design philosophy: *built for the model's fallibility, not its intelligence* — the thesis, the living table of refusals in the product, and an honest admission of the one place still below our own bar. |
